...
def parse_args():
    ...
    parser.add_argument('--output_dir', type=str, required=True, help="Where to store output model and logs")
...
if __name__ == "__main__":
    try:
        ...
        run_training_pipeline(args.data_dir, args.output_dir, args.epochs)
