...
if __name__ == "__main__":
    try:
        ...
        logger.info(f"Starting training: data_dir={args.data_dir}, model_dir={model_dir}, epochs={args.epochs}")
        run_training_pipeline(args.data_dir, model_dir, args.epochs)
