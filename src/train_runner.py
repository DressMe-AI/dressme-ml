...
def parse_args():
    ...
    parser.add_argument('--output_dir', type=str, required=False, default="/opt/ml/output", help="Directory for logs and final model")
...
if __name__ == "__main__":
    try:
        args = parse_args()
        logger.info(f"Starting training: data_dir={args.data_dir}, model_dir={args.model_dir}, epochs={args.epochs}")
